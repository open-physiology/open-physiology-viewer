export const $LogMsg = {
    ...
    CHAIN_HOUSING_TEMPLATE_UNDEFINED      : "Failed to find chain's housing lyph template definition",
    CHAIN_TEMPLATE_INCOMPLETE   : "Chain template inclomplete: lyph template or level lyphs are missing",
    CHAIN_HOUSING_LYPH_TEMPLATE_NO_LAYERS: "Housing lyph template with no layers",
    ...
    CHAIN_CRITICAL_ERROR        : "Critical chain generation error, definition needs revision",
